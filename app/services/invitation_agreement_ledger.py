...
def emit_invitation_agreement_signed_if_dropbox_complete(
    ...
    *,
    ...
    # Fix Bug #5b: Mark invitation as accepted and token as BURNED only when signing is complete.
    # This ensures the token remains valid during the Dropbox Sign flow.
    inv.status = "accepted"
